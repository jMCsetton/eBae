...
<div class="w3-main" style="margin-left:300px">
  ...
  <header id="portfolio">
    ...
    <h2><b>Showing all auctions you've created:</b></h2>
                   ...
                   echo '
                       ...
                       if ($row2["buyername"] == 'Auction Still Open') {
                        ...
                        echo '<td>Already rated</td> </tr>';
                         ...
                         <a href='giveSellerFeedback.php?id=".$row2['productid']."' class='w3-third w3-container' style='background-color:black; width:85%; color:white'><b>Rate User<b></a> 
                        </td> </tr>";
                       }
