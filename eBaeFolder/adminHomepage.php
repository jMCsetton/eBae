  ...
  <?php
        ...
        while ($row = mysqli_fetch_assoc($result)) {          
          ...
          echo '
            ...
            <td><a href="deletephp.php?id='.$row["productID"].'" type="submit" name="submit" class="btn btn-danger btn-block btn-round" onClick="return confirm(\'Delete This account?\')";>Delete</a>
