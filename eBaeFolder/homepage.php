...
$sql = "SELECT productImage, productName, reservePrice, date_format(enddate, '%d-%m-%Y') enddate, category, quantity, conditions, productInfo FROM product ORDER BY YEAR(enddate) ASC, MONTH(enddate) ASC, DAY(enddate) ASC";
        ...
        //header("Content-type: image/png"); 
          ...
          echo '
            <div style= "bg-colour:white" class="w3-twothird w3-container">
              ...
              <br><a href = "auctionDetails.php" class="w3-button w3-black">View Bids</a>
              <br>
              <br>
              <br>
            </div>
