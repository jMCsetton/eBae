...
<div class="w3-main" style="margin-left:300px">
 ...
 <?php
        ...
        while ($row = mysqli_fetch_assoc($resultJA)) {
          ...
          $_SESSION['productID'] = $row['productID'];
          $productID = $_SESSION['productID'];
          // echo "<a href='auctionDetails.php?id=".$row['productID']."' class='w3-container' style='background-color:black; width:9%; color:white'><b>View Bid<b></a> 
          // ";
          echo '
          "<a href='auctionDetails.php?id=".$row['productID']."' class='w3-container' style='background-color:black; width:9%; color:white'><b>View Bid<b></a> 
          ";
