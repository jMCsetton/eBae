...
$sql = "SELECT productImage, productName, reservePrice, date_format(enddate, '%e-%m-%Y') enddate, category, quantity, conditions, productInfo FROM product ORDER BY endDate ASC";
